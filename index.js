...
mongoose.connect('mongodb+srv://AhmedMohamed:hamada539327@cluster0.4lopz.mongodb.net/nadatest?retryWrites=true&w=majority').then(()=>console.log("connect correctly to mongo database"));
